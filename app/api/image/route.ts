...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let resolvedUrl = await imageProtocols.getDisplayUrl(rawUrl);
    ...
    if (outputFormat === "webp") sharpInstance = sharpInstance.webp({ quality });
    else if (outputFormat === "jpeg") sharpInstance = sharpInstance.jpeg({ quality });
    else if (outputFormat === "png") sharpInstance = sharpInstance.png();
    else if (outputFormat === "avif") sharpInstance = sharpInstance.avif({ quality });
