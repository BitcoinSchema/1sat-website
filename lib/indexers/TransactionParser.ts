...
/**
 * WalletServices interface for network operations
 * Simplified version for 1sat-web
 */
export interface WalletServices {
  getRawTx(txid: string): Promise<{ rawTx?: number[]; error?: Error }>;
  getOrdfsMetadata?(outpoint: string, includeMap?: boolean): Promise<OrdfsMetadata | undefined>;
}
