...
const Market = async ({
	...
	searchParams: Promise<{ sort: SortBy; dir: "asc" | "desc" }>;
}) => {
	...
	switch (tab) {
		...
		case AssetType.BSV20:
			return (
				<MarketPage selectedAssetType={AssetType.BSV20} sort={sort} dir={dir} />
			);
		case AssetType.BSV21:
			return (
				<MarketPage selectedAssetType={AssetType.BSV21} sort={sort} dir={dir} />
			);
		default:
			return null;
	}
