...
import { AlertTriangle, Download, FileUp, Key } from "lucide-react";
	...
	const handleImportData = useCallback(
		(data: Keys) => {
			try {
				...
				console.log(
					"Not sending success to original window yet. Migrating?",
					migrating.value,
				);
			} catch (e) {
			...
			<DialogContent className="bg-background border-border max-w-lg">
				...
				{!alreadyHasKey && (
					<>
						...
						{open && importWalletTab.value === ImportWalletTab.FromMnemonic && (
							<div>
								{importWalletFromMnemonicStep.value ===
									ImportWalletFromMnemonicStep.EnterMnemonic && (
									<EnterMnemonicStep />
