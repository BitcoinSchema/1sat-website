import { CheckCircle2, Wallet, Shield } from "lucide-react";
    ...
    <div className="flex flex-col items-center py-6">
      ...
      <div className="grid grid-cols-2 gap-3 w-full mb-6">
        <div className="flex items-center gap-2 p-3 bg-card border border-border rounded">
          ...
          <span className="text-xs font-mono text-muted-foreground">Keys Restored</span>
        </div>
        <div className="flex items-center gap-2 p-3 bg-card border border-border rounded">
          <Shield className="w-4 h-4 text-primary" />
          <span className="text-xs font-mono text-muted-foreground">Encrypted</span>
        </div>
      </div>
