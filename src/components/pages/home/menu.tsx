		...
		<div className="relative">
			...
			<div className="flex mx-auto max-w-fit gap-4 mt-16">
				<Link
					...
					className="font-mono flex flex-col btn md:btn-lg btn-ghost border-neutral/75 hover:border-warning/25 font-bold mb-4 transition"
					onMouseEnter={mouseEnter}
					onMouseLeave={mouseLeave}
				>
					Ordinals
					<span className="font-normal text-xs text-warning/50 opacity-50 hover:opacity-100 transition-opacity duration-1000">
						Art NFTs
					</span>
				</Link>
				<Link
