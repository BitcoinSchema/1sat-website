import { MINI_API_HOST, NUMBER_OF_ITEMS_PER_PAGE } from "@/constants";
...
export const fetchCollectionItems = async (
	...
	const collectionItemsUrl = `${MINI_API_HOST}/collection/${collectionId}/items?offset=${offset}&limit=${limit}`;
...
export const fetchCollectionMarket = async (
	...
	const collectionMarketUrl = `${MINI_API_HOST}/collection/${collectionId}/market?offset=${offset}&limit=${limit}`;
