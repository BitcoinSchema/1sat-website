...
test('all outpoint tabs should work without full page reload', async ({ page }) => {
  // Test the outpoint with owner tab
  await page.goto('http://localhost:3000/outpoint/6b051a59c44907f65a1c8d0838007fe57d6ddd3ebc4378e80d04da76b1e707c8_0/timeline');
  ...
  const tabButtons = await page.locator('[role="tablist"] button[role="tab"]').all();
